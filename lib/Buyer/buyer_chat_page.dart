...
class BuyerChatPage extends StatefulWidget {
  ...
  const BuyerChatPage({super.key, required this.contactName, this.peerUserId});

  @override
  State<BuyerChatPage> createState() => _BuyerChatPage();
}

class _BuyerChatPage extends State<BuyerChatPage> {
  ...
  Future<void> _sendMessage() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Open chat from Messages or a product to reply here.')),
    );
  }
            ...
            child: _useApi
                ...
                : const Center(
                    child: Padding(
                      ...
                      child: Text(
                        'No conversation selected. Open this screen from Messages or a product.',
