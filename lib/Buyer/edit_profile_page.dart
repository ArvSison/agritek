...
class _EditProfilePageState extends State<EditProfilePage> {
        ...
        return Theme(
          data: Theme.of(context).copyWith(
            ...
            textButtonTheme: TextButtonThemeData(
              style: TextButton.styleFrom(foregroundColor: const Color(0xFF024E44)),
            ),
          ),
          child: child!,
        );
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Edit Profile', style: TextStyle(color: Color(0xFFF0FFE2))),
          ...
          child: Form(
            ...
            child: Column(
              children: [
                ...
                label("Username"),
                TextFormField(controller: usernameController, decoration: inputStyle("Enter username")),
                const SizedBox(height: 16),

                label("Name"),
                TextFormField(controller: nameController, decoration: inputStyle("Enter name")),
                const SizedBox(height: 16),

                label("Email"),
                TextFormField(controller: emailController, decoration: inputStyle("Enter email")),
                const SizedBox(height: 16),

                label("Address"),
                TextFormField(controller: addressController, decoration: inputStyle("Enter address")),
                const SizedBox(height: 16),
                ...
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    borderRadius: BorderRadius.circular(25),
                    boxShadow: [
                      BoxShadow(color: Colors.black12, blurRadius: 4, offset: const Offset(1, 3)),
                    ],
                  ),
                ...
                ElevatedButton(
                  ...
                  child: _saving
                      ...
                      : const Text("Save Profile", style: TextStyle(fontSize: 18, color: Color(0xFFF0FFE2))),
                ),
              ],
            ),
          ),
